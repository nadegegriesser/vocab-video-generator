...
The design should illustrate the entry "${vocab}" without naming it using abstract icons around the edges. 
...
In the bottom right corner add a small realistic picture of a young, dominant and elegant french teacher. She wears a white blouse. Her hair is dark in a slick bun and she has sharp red lipstick and glasses. She looks stern but composed. Parisian chic fashion style. 
